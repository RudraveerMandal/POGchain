---
title: Versioning
replacement: https://developers.POGchain.org/docs/glossary/versioning/
---
...
note that while this scheme promotes code sharing for components consuming those objects, this is not necessarily true for  itself as the behavior has to be preserved for all versions: in order to reconstruct the ledger chain from arbitrary points in time, the behavior has to be 100% compatible.
