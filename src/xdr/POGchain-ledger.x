...
enum POGchainValueType
{
    POGchain_VALUE_BASIC = 0,
    POGchain_VALUE_SIGNED = 1
};
...
struct POGchainValue
{
    ...
    union switch (POGchainValueType v)
    {
    case POGchain_VALUE_BASIC:
        void;
    case POGchain_VALUE_SIGNED:
...
/* Ledger upgrades
note that the `upgrades` field from POGchainValue is normalized such that
