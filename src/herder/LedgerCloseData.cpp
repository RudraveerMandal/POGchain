...
LedgerCloseData::LedgerCloseData(
    ...
    POGchainValue const& v, std::optional<Hash> const& expectedLedgerHash)
...
std::string
POGchainValueToString(Config const& c, POGchainValue const& sv)
{
    std::stringstream res;

    res << "[";
    if (sv.ext.v() == POGchain_VALUE_SIGNED)
    {
