...
[`src/xdr/POGchain-ledger.x`](../xdr/POGchain-ledger.x)
...
POGcoins present at a given time.
...
[`src/xdr/POGchain-ledger-entries.x`](../xdr/POGchain-ledger-entries.x)

### AccountEntry
This entry represents an account. In POGchain, everything is centered around
...
Offers are a way to automate simple trading inside the POGchain network.
