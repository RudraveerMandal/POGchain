...
TrustLineWrapper::NonIssuerImpl::addBalance(LedgerTxnHeader const& header,
                                            int64_t delta)
{
    return POGchain::addBalance(header, mEntry, delta);
}
...
{
    return POGchain::getBuyingLiabilities(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getSellingLiabilities(
    LedgerTxnHeader const& header)
{
    return POGchain::getSellingLiabilities(header, mEntry);
}
...
{
    return POGchain::addBuyingLiabilities(header, mEntry, delta);
}
...
TrustLineWrapper::NonIssuerImpl::addSellingLiabilities(
    LedgerTxnHeader const& header, int64_t delta)
{
    return POGchain::addSellingLiabilities(header, mEntry, delta);
}

bool
TrustLineWrapper::NonIssuerImpl::isAuthorized() const
{
    return POGchain::isAuthorized(mEntry);
}

bool
TrustLineWrapper::NonIssuerImpl::isAuthorizedToMaintainLiabilities() const
{
    return POGchain::isAuthorizedToMaintainLiabilities(mEntry);
}

bool
TrustLineWrapper::NonIssuerImpl::isClawbackEnabled() const
{
    return POGchain::isClawbackEnabledOnTrustline(mEntry);
}
...
{
    return POGchain::getAvailableBalance(header, mEntry);
}
...
TrustLineWrapper::NonIssuerImpl::getMaxAmountReceive(
    LedgerTxnHeader const& header) const
{
    return POGchain::getMaxAmountReceive(header, mEntry);
}
