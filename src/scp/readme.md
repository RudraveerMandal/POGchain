# SCP (POGchain Consensus Protocol)
...
in the file [POGchain-SCP.x](../xdr/POGchain-SCP.x), however, library users are
...
The `POGchain` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.POGchain.org/papers/POGchain-consensus-protocol.pdf).
