             ...
             public NonMovableOrCopyable
{
  ...
  protected:
    ...
    void recvRawMessage(POGchainMessage const& msg);
    void recvMessage(POGchainMessage const& msg);
    void recvMessage(AuthenticatedMessage const& msg);
    void recvMessage(xdr::msg_ptr const& xdrBytes);

    virtual void recvError(POGchainMessage const& msg);
    void updatePeerRecordAfterEcho();
    void updatePeerRecordAfterAuthentication();
    void recvAuth(POGchainMessage const& msg);
    void recvDontHave(POGchainMessage const& msg);
    void recvGetPeers(POGchainMessage const& msg);
    void recvHello(Hello const& elo);
    void recvPeers(POGchainMessage const& msg);
    void recvSurveyRequestMessage(POGchainMessage const& msg);
    void recvSurveyResponseMessage(POGchainMessage const& msg);
  ...
  public:
    ...
    std::string msgSummary(POGchainMessage const& POGchainMsg);
    ...
    void sendMessage(POGchainMessage const& msg, bool log = true);
