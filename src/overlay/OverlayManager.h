 ...
 * `POGchainMessage`, in the file src/xdr/POGchain-overlay.x
 *
 ...
 *
 * The `POGchainMessage` union contains 3 logically distinct kinds of message:
 *
...
class OverlayManager
{
  public:
    ...
    virtual bool broadcastMessage(POGchainMessage const& msg,
                                  bool force = false) = 0;
    ...
    virtual bool recvFloodedMsgID(POGchainMessage const& msg, Peer::pointer peer,
                                  Hash& msgID) = 0;

    bool
    recvFloodedMsg(POGchainMessage const& msg, Peer::pointer peer)
    {
        Hash msgID;
    ...
    virtual void recordMessageMetric(POGchainMessage const& POGchainMsg,
                                     Peer::pointer peer) = 0;

    virtual void updateFloodRecord(POGchainMessage const& oldMsg,
                                   POGchainMessage const& newMsg) = 0;
