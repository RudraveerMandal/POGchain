...
class OverlayManagerImpl : public OverlayManager
{
  ...
  public:
    ...
    bool recvFloodedMsgID(POGchainMessage const& msg, Peer::pointer peer,
                          Hash& msgID) override;
    void forgetFloodedMsg(Hash const& msgID) override;
    bool broadcastMessage(POGchainMessage const& msg,
    ...
    void recordMessageMetric(POGchainMessage const& POGchainMsg,
                             Peer::pointer peer) override;

    void updateFloodRecord(POGchainMessage const& oldMsg,
                           POGchainMessage const& newMsg) override;
