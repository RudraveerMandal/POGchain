...
void
SurveyManager::relayOrProcessResponse(POGchainMessage const& msg,
                                      Peer::pointer peer)
{
...
void
SurveyManager::relayOrProcessRequest(POGchainMessage const& msg,
                                     Peer::pointer peer)
{
...
SurveyManager::makeSurveyRequest(NodeID const& nodeToSurvey) const
{
    ...
    request.ledgerNum = mApp.getHerder().trackingvalidationLedgerIndex();
    request.surveyorPeerID = mApp.getConfig().NODE_SEED.getPublicKey();
...
void
SurveyManager::broadcast(POGchainMessage const& msg) const
{
...
std::string
SurveyManager::getMsgSummary(POGchainMessage const& msg)
{
    std::string summary;
