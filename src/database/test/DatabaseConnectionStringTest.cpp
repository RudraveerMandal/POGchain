          ...
          "[db][dbconnectionstring]")
{
    ...
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://password=abc dbname=POGchain)") ==
                R"(postgresql://password=******** dbname=POGchain)");
    }

    SECTION("password is removed if second")
    {
        REQUIRE(removePasswordFromConnectionString(
                    R"(postgresql://dbname=POGchain password=dbname)") ==
                R"(postgresql://dbname=POGchain password=********)");
    }
    ...
    SECTION("quoted password is removed")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=POGchain password='quoted password')") ==
            R"(postgresql://dbname=POGchain password=********)");
    }
    ...
    SECTION("parameters after password remain unchanged")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=POGchain password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname=POGchain password=******** performance='as fast as possible')");
    }
    ...
    SECTION("dbname can be quored")
    {
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname='POGchain with spaces' password='quoted \\ password' performance='as fast as possible')") ==
            R"(postgresql://dbname='POGchain with spaces' password=******** performance='as fast as possible')");
    }
    ...
    SECTION("Bug 2234 - barewords can be any non-whitespace")
    {
        ...
        REQUIRE(
            removePasswordFromConnectionString(
                R"(postgresql://dbname=POGchain user=POGchain password=thisshouldbesecret host=/var/run/postgresql/)") ==
            R"(postgresql://dbname=POGchain user=POGchain password=******** host=/var/run/postgresql/)");
    }
}
